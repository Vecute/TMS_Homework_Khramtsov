...
//   const { id, image, content, publishedAt, title } = props;
//   const size: Size = getRandomSize();
//   return (
//     <div className={`post-card ${size}`} id={id.toString()}>
...
//           <div className="post-card__like post__icons-container">
//             <svg
//               width="20px"
//               height="20px"
//               viewBox="0 0 24 24"
...
//             </svg>
//           </div>
//           <span className="post-card__like-counter">15</span>
//           <div className="post-card__dislike post__icons-container">
//             <svg
//               width="20px"
//               height="20px"
//               viewBox="0 0 24 24"
...
//           <div className="post-card__favorite post__icons-container">
//             <svg
//               width="20px"
//               height="20px"
//               viewBox="0 0 24 24"
...
//             </svg>
//           </div>
//           <div className="post-card__options post__icons-container">
//             <svg
//               width="20px"
//               height="20px"
//               viewBox="0 0 24 24"
...
export const PostCard = (props: PostProps) => {
  const { id, image, content, publishedAt, title, size } = props;
  const [likeState, setLikeState] = useState<LikeState>(undefined);
  const [likeCounter, setLikeCounter] = useState(15);
  ...
  return (
    <div className={`post-card ${size}`} id={id.toString()}>
      ...
      <div className="post-card__bottom-menu">
        <div className="post-card__likes-menu">
          <div
            className={`post-card__like post__icons-container ${
          ...
          <div
            className={`post-card__dislike post__icons-container ${
